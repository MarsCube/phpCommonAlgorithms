...
//        var_dump(($hash % 0xFFFFFFFF) & 0xFFFFFFFF);die;
    ...
    public function DJBHash($string, $len = null) {
        ...
        var_dump(($hash % 0xFFFFFFFF) & 0xFFFFFFFF);
        die;
        return ($hash % 0xFFFFFFFF) & 0xFFFFFFFF;
    }
...
//        var_dump(($hash % 0xFFFFFFFF) & 0xFFFFFFFF);die;
    ...
    public static $IPHASH_TABLE_SIZE = 256;

    /**
     * 
     */
    public function HashInaddr(int $key) {
        $key ^= ($key >> 16);
        return (($key >> 8) ^ $key) % self::$IPHASH_TABLE_SIZE;
    }
